...
<body>
    ...
    <form method = "POST" action = "vote_result.php">
        ...
        <div class="col-lg-6">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading"><center>
                       Anura Kumarara Dissanayaka</center>
                </div>
                <div class="panel-body" style = "background-color:">
                    <?php
        ...
        <div class="col-lg-6">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <center>Mahinda Rajapaksha</center>
                </div>
                <div class="panel-body" style = "background-color:">
                    <?php
        ...
        <div class="col-lg-6">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <center>Sunil Hadunheththi</center>
                </div>
                <div class="panel-body" style = "background-color:">
                    <?php
        ...
        <div class="col-lg-6">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <center>Vijaya Kumarathunga</center>
                </div>
                <div class="panel-body" style = "background-color:">
                    <?php
        ...
        <div class="col-lg-6">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <center>Bhathiya Thisera</center>
                </div>
                <div class="panel-body" style = "background-color:">
                    <?php
        ...
        <div class="col-lg-6">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <center>Ranjan Ramanayaka</center>
                </div>
                <div class="panel-body" style = "background-color:">
                    <?php
        ...
        <center><button class = "btn btn-success ballot" type = "submit" name = "submit">Vote</button></center>
    </form>
</body>
