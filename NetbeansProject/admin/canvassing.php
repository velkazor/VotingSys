                ...
                <div class="panel panel-default">
                    ...
                    <form method="post" action="sort.php">
                        ...
                        <select name="position" id="position" class = "form-control pull-left" style = "width:300px;margin-left:19px; ">
                            ...
                            <option>Priminister </option>
                            <option>Member Of Parliment</option>
                            <option>Minister Of Parliment</option>
                            <option>Member of the provincial council</option>
                            <option>Member of Pradeshiya sabha</option>
                          >
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-striped table-bordered table-hover ">
                            <thead>
                            <td style = "width:600px;" class = "alert alert-success">Podujana Peramuna</td>
...
<?php } ?>
                        ...
                        <table class="table table-striped table-bordered table-hover ">
                            <thead>
                            <td style = "width:600px;"class = "alert alert-success">Unaited Nation Party ( UNP )</td>
                            <td style = "width:200px;" class = "alert alert-success">Image</td>
                            <td class = "alert alert-success">Total</td>
...
<?php } ?>
                        ...
                        <table class="table table-striped table-bordered table-hover ">
                            <thead>
                            <td style = "width:600px;"class = "alert alert-success">Janatha Vimukthi Peramuna ( JVP ) </td>
                            <td style = "width:200px;" class = "alert alert-success">Image</td>
                            <td class = "alert alert-success">Total</td>
...
while ($fetch = $query->fetch_array()) {
    ...
    ?>
                        ...
                        <table class="table table-striped table-bordered table-hover ">
                            <thead>
                            <td style = "width:600px;"class = "alert alert-success">Sri Lanka Freedom Party</td>
                            <td style = "width:200px;" class = "alert alert-success">Image</td>
                            <td class = "alert alert-success">Total</td>
...
while ($fetch = $query->fetch_array()) {
    ...
    ?>
                        ...
                        <table class="table table-striped table-bordered table-hover ">
                            <thead>
                            <td style = "width:600px;"class = "alert alert-success">Labor Party Of Sri Lanka</td>
                            <td style = "width:200px;" class = "alert alert-success">Image</td>
                            <td class = "alert alert-success">Total</td>
